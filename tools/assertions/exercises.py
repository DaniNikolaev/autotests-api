...
from clients.exercises.exercises_schema import ExerciseSchema, CreateExerciseResponseSchema, \
    CreateExerciseRequestSchema, GetExerciseResponseSchema, UpdateExerciseResponseSchema, UpdateExerciseRequestSchema, \
...
def assert_create_exercise_response(response: CreateExerciseResponseSchema,
...
def assert_update_exercise_response(response: UpdateExerciseResponseSchema,
...
def assert_get_exercises_response(get_exercises_response: GetExercisesResponseSchema,
    ...
    for index, exercise in enumerate(create_exercise_responses):
        assert_exercise(get_exercises_response.exercises[index], exercise.exercise)
