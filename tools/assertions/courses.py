...
from clients.courses.courses_schema import CourseSchema, UpdateCourseResponseSchema, UpdateCourseRequestSchema, \
...
def assert_get_course_response(get_course_response: GetCourseResponseSchema,
    ...
    """
    Проверяет, что получаемые данные курса соответствуют ожидаемым.

    :param get_course_response: Фактические данные курса.
    :param create_course_response: Ожидаемые данные курса.
    :raises AssertionError: Если хотя бы одно поле не совпадает.
    """
...
def assert_get_courses_response(get_courses_response: GetCoursesResponseSchema,
    ...
    for index, course in enumerate(create_course_responses):
        assert_course(get_courses_response.courses[index], course.course)


@allure.step("Check update course response")
def assert_update_course_response(response: UpdateCourseResponseSchema,
...
def assert_create_course_response(response: CreateCourseResponseSchema,
